(function(window) {
	...
	// Указываем ссылку на коструктор.
	Observatorium.prototype = {
		constructor: Observatorium
	};

	// Указываем ссылку на конструктор в глобальном области видимости.
	window.Observatorium = Observatorium;
})(window);
